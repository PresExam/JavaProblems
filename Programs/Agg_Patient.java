...
public class Agg_Patient {
    String patientName;
    int patientAge;
    String dob;
    String disease;
    Agg_Information info;
    Agg_Payment payment;
    public Agg_Patient(String patientName, int patientAge, String dob, String disease, Agg_Information info, Agg_Payment payment){
